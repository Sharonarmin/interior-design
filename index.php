                        ...
                        <div class="latest-project-slider owl-carousel">
                            <div class="latest-projects">
                                <div class="latest-projects-box">
                                    <img class="img-fluid" src="assets/images/slider/slider-1.png" alt="">
                            ...
                            <div class="latest-projects">
                                <div class="latest-projects-box">
                                    <img class="img-fluid" src="assets/images/slider/slider-2.png" alt="">
                                    <div class="latest-project-dtls">
                                        <p class="head">Living Room</p>
                                        <div class="project-location"><i class="fa-regular fa-building"></i>Landmark, Kozhikode</div>
                            ...
                            <div class="latest-projects">
                                <div class="latest-projects-box">
                                    <img class="img-fluid" src="assets/images/slider/slider-3.jpg" alt="">
                                    <div class="latest-project-dtls">
                                        <p class="head">Living Room</p>
                                        <div class="project-location"><i class="fa-regular fa-building"></i>Landmark, Kozhikode</div>
            ...
            <h3 class="main-head mt-md-3 mt-3">What Our Customers Say !</h3>
                <div class="testimonial-slider owl-carousel">
                            <div class="testimonial-box">
                                ...
                                <div class="review">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus nibh mauris, nec turpis orci lectus maecenas.
